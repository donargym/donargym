...
class UitslagenPdfController extends AlphaPDFController
{
    ...
    function Header()
    {
        ...
        $this->Cell(277, 10, "Donar OW " . date('Y', time()) . ": Uitslagenlijst " .
            $this->categorie . " niveau " .
            $this->niveau, 0, 1, 'C');
        $this->Ln(6);
        ...
        $header2 = array('Nr.', 'Naam', 'Groep', 'D1', 'N1', 'Spr1', 'D2', 'N2', 'Spr2', 'Pnt', 'Pl', 'D', 'N',
    ...
    function Table($turnsters, $userId)
    {
        foreach ($turnsters as $turnster) {
            ...
            if(in_array($turnster['rankSprong'],array(1,2,3))) {
            ...
            if(in_array($turnster['rankBrug'],array(1,2,3))) {
                $this->SetFont('Helvetica','B',7);
                $this->SetFillColor(255,255,0);
            ...
            if(in_array($turnster['rankBalk'],array(1,2,3))) {
                $this->SetFont('Helvetica','B',7);
                $this->SetFillColor(255,255,0);
