...
class Trainingen
{
     ...
     * Add trainingsdata
     *
     * @param \App\Entity\Trainingsdata $trainingsdata
     * @return Trainingen
     */
    public function addTrainingsdatum(\App\Entity\Trainingsdata $trainingsdata)
    {
     ...
     * @param \App\Entity\Trainingsdata $trainingsdata
     */
    public function removeTrainingsdatum(\App\Entity\Trainingsdata $trainingsdata)
    {
