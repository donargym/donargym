...
/**
 * @ORM\Entity(repositoryClass="App\Repository\TurnsterRepository")
...
class Turnster
{
    ...
    /**
     * @ORM\OneToOne(targetEntity="Scores", cascade={"persist", "remove"}, inversedBy="turnster")
     ...
     * Set vloermuziek
     *
     * @param \App\Entity\Vloermuziek $vloermuziek
     * @return Turnster
     */
    public function setVloermuziek(\App\Entity\Vloermuziek $vloermuziek = null)
    {
     ...
     * Set scores
     *
     * @param \App\Entity\Scores $scores
     * @return Turnster
     */
    public function setScores(\App\Entity\Scores $scores = null)
    {
        $this->scores = $scores;
