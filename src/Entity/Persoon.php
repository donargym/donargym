...
class Persoon
{
     ...
     * Set foto
     *
     * @param \App\Entity\SelectieFoto $foto
     * @return Persoon
     */
    public function setFoto(\App\Entity\SelectieFoto $foto = null)
    {
        $this->foto = $foto;
     ...
     * Get foto
     *
     * @return \App\Entity\SelectieFoto
     */
     ...
     * Set stukje
     *
     * @param \App\Entity\Stukje $stukje
     * @return Persoon
     */
    public function setStukje(\App\Entity\Stukje $stukje = null)
    {
        $this->stukje = $stukje;
